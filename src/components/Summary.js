...
const Summary = ({ userAnswers }) => {
    ...
    const skippedAnswerPercentage = Math.round((skippedAnswers.length / QUESTIONS.length) * 100);
    const correctAnswerPercentage = Math.round((correctAnswers.length / QUESTIONS.length) * 100);
